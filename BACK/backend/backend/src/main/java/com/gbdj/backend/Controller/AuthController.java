...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
        ...
        if (response != null && "OK".equals(response.get("status"))) {
            ...
            String mensaje = response != null && response.get("mensaje") != null ? response.get("mensaje").toString()
    ...
    public ResponseEntity<?> actualizarPerfil(@RequestBody ActualizarPerfilRequest request) {
        ...
        if (response != null && "OK".equals(response.get("status"))) {
            ...
            String mensaje = response != null ? response.get("mensaje").toString() : "Error al actualizar perfil";
    ...
    public ResponseEntity<?> listarAsesores() {
        try {
            ...
            if (response != null && "OK".equals(response.get("status"))) {
                ...
                String mensaje = response != null ? response.get("mensaje").toString() : "Error al listar asesores";
                return ResponseEntity.status(500).body(Map.of(
                        "status", "ERROR",
                        "mensaje", mensaje));
            }
    ...
    public ResponseEntity<?> registerCliente(@RequestBody ClienteRegisterRequest request) {
        ...
        clienteData.put("P_LICENCIACONDUCCION",
                request.getLicenciaConduccion() != null ? request.getLicenciaConduccion() : "N");
        ...
        if ("OK".equals(response.get("status"))) {
            ...
            String mensaje = response.get("mensaje") != null ? response.get("mensaje").toString()
    ...
    public ResponseEntity<?> obtenerAsesorPorCedula(@PathVariable Long cedula) {
        ...
        try {
            ...
            if (response != null && "OK".equals(response.get("status"))) {
                ...
                String mensaje = response != null ? response.get("mensaje").toString() : "Asesor no encontrado";
                return ResponseEntity.status(404).body(Map.of(
                        "status", "ERROR",
                        "mensaje", mensaje));
            }
    ...
    public ResponseEntity<?> actualizarAsesor(
        ...
        try {
            ...
            if (response != null && "OK".equals(response.get("status"))) {
                ...
                String mensaje = response != null ? response.get("mensaje").toString() : "Error al actualizar asesor";
                return ResponseEntity.status(500).body(Map.of(
                        "status", "ERROR",
                        "mensaje", mensaje));
            }
    ...
    public ResponseEntity<?> eliminarAsesor(@PathVariable Long cedula) {
        ...
        try {
            ...
            if (response != null && "OK".equals(response.get("status"))) {
                ...
                String mensaje = response != null ? response.get("mensaje").toString() : "Error al eliminar asesor";
                return ResponseEntity.status(500).body(Map.of(
                        "status", "ERROR",
                        "mensaje", mensaje));
            }
